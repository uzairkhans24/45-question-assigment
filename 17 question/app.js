"use strict";
// Shrinking Guest List: You just found out that your new dinner table won’
...
while (Guest_List.length > 2) {
    ...
    console.log(`Sorry, due to limited space we can not invite you to Dinner Mrs ${notInvited} \n`);
}
for (let i = 0; i < Guest_List.length; i++) {
